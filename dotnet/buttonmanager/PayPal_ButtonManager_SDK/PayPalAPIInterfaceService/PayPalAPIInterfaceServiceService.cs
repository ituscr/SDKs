	...
	public partial class PayPalAPIInterfaceServiceService : BasePayPalService 
	{
		...
		/**	
	 	...
	 	public RefundTransactionResponseType RefundTransaction(RefundTransactionReq refundTransactionReq, string apiUserName)
	 	{
			...
			apiCallPreHandler = new SOAPAPICallPreHandler(defaultHandler, apiUserName, getAccessToken(), getAccessTokenSecret());
			((SOAPAPICallPreHandler) apiCallPreHandler).SDKName = SDKName;
			((SOAPAPICallPreHandler) apiCallPreHandler).SDKVersion = SDKVersion;
